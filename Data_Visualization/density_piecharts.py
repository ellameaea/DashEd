...
# Create figure for Public Pie Chart
def public_pie_chart():
    # Import and preprocess data from Public_PieChart.py
...
# Create figure for Private Pie Chart
def private_pie_chart():
    # Import and preprocess data from Private_PieChart.py
    df = pd.read_csv('CSV Files/CLEANED_SY2023_Enrollment.csv')
    ...
    all_enrollee_columns = [col for level_cols in combined_levels.values() for col in level_cols]
    private_schools['Total Enrollees'] = private_schools[all_enrollee_columns].sum(axis=1)
