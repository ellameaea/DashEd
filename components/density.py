...
def create_density_content():
    ...
    html.Div(dcc.Graph(id='public-pie-chart', figure=public_pie_chart(), config={'responsive': True}, style={"height": "50%"}))], style={"max-height": "820px", "display": "flex", "flexDirection": "column"})
